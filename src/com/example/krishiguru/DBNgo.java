...
public class DBNgo extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
    	 ...
    	 final ListAdapter adapter = new SimpleAdapter(this, NgoList,
				R.layout.list_item,
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent in = new Intent(getApplicationContext(), Ngodetail.class);
